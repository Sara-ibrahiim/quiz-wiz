        ...
        <Sidebar collapsed={isCollapse} className="h-full">
          ...
          >
            <MenuItem
              ...
              icon={
                <FiAlignJustify className='text-primaryDark dark:text-lightText' style={{
                    fontSize:  "20rem",
            ...
            <MenuItem
              ...
              icon={<RiHome6Line  className="bg-secondaryLight text-primaryDark px-1 rounded text-4xl"/>}
            ...
            {/* { ? ( */}
              <MenuItem
                ...
                icon={<GrGroup  className="bg-secondaryLight text-primaryDark px-1 rounded text-4xl"/>}
            ...
            <MenuItem
              className="text-primaryDark dark:text-lightText  "
              icon={<TfiTimer  className="bg-secondaryLight text-primaryDark px-1 rounded text-4xl"/>}
            ...
            <MenuItem
                className="text-primaryDark dark:text-lightText  "
                icon={<TfiWrite className="bg-secondaryLight text-primaryDark p-1 rounded text-4xl"/>}
            ...
            <MenuItem
                className="text-primaryDark dark:text-lightText  "
                icon={<PiStudent   className="bg-secondaryLight text-primaryDark p-1 rounded text-4xl"/>}
                // component={<NavLink to="" />}
              >
                {" "}
                Students
...
{/* 
            { ( */}
              <MenuItem
                className="text-primaryDark dark:text-lightText  "
                icon={<FaRegFileAlt  className="bg-secondaryLight text-primaryDark p-1 rounded text-4xl"/>}
                // component={<NavLink to="" />}
              >
                {" "}
                Results
            ...
            <MenuItem
              className="text-primaryDark dark:text-lightText   "
            //   onClick={}
            icon={<RiLockPasswordLine  className="bg-secondaryLight text-primaryDark px-1 rounded text-4xl"/>}
            ...
            <MenuItem
              className="text-primaryDark dark:text-lightText  "
              icon={<SlLogout  className="bg-secondaryLight text-primaryDark px-1 rounded text-4xl"/>}
              onClick={
