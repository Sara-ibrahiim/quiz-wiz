...
const AuthButton = ({ title }: AuthButtonProps) => {
  return (
    <div>
      <button
        type="submit"
        className="flex gap-4 transition-all text-lg duration-300 ease-in-out bg-primaryDark  px-7 py-4 rounded-md text-white dark:bg-primaryLight dark:text-primaryDark font-bold hover:bg-gray-600 hover:dark:bg-gray-300"
      >
        <span>{title}</span>
